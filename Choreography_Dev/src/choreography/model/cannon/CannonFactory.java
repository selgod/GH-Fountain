...
public class CannonFactory {
	...
	public static IndependentCannon createIndependentCannon(CannonEnum e) {
		...
		default:
			throw new IllegalArgumentException("must be an IndependentCannon");
		}
	}
	...
	public static Module createModule(int number) {
		return new Module(number, createCannon(CannonEnum.RING1), createCannon(CannonEnum.RING2), createCannon(CannonEnum.RING3), createCannon(CannonEnum.RING4), createCannon(CannonEnum.RING5), createCannon(CannonEnum.MULTI), createCannon(CannonEnum.CANDELABRA), createCannon(CannonEnum.SWEEP));
	}
	...
	public static ModuleGroup createModuleGroup(String aB) {
		switch (aB) {
		case "A":
			return new ModuleGroup(new Module[] { createModule(1), createModule(3), createModule(5), createModule(7) });
		case "B":
